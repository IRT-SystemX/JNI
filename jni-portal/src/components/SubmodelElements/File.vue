...
export default defineComponent({
    ...
    methods: {
        ...
        updatePath() {
            ...
            let path = this.SelectedNode.basePath  + '/' + this.SelectedNode.path + '/$value';
            let content = JSON.stringify({contentType: this.fileObject.contentType, value: this.newPathValue});

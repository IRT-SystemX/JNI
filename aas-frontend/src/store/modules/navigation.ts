...
const getters = {
    ...
    getSubmodelRegistryURL(state: state) {
        return state.submodelRegistryURL;
    },
...
const actions = {
    ...
    dispatchSubmodelRegistryURL({ commit }: { commit: Function }, url: string) {
        // console.log('dispatchSubmodelRegistryURL: ', url);
        commit('setSubmodelRegistryURL', url);
    },
...
const mutations = {
    ...
    setSubmodelRegistryURL(state: state, url: string ) {
        state.submodelRegistryURL = url;
    },

...
>IMPORTANT: Use Host’s Docker Environment
>If you are running dagu using a container, you need the setup below.
>
>Run a socat container with the command below.
>
...
Forum discussion about the subject:
https://forums.docker.com/t/remote-api-with-docker-for-mac-beta/15639/2

For more details about the docker executor:
https://dagu.readthedocs.io/en/latest/yaml_format.html#docker-executor

## Systemx Fork New Features
...
1. Workflow & Tasks Templates
   ...
   - Benefits:
     ...
     - Facilitates knowledge sharing and best practices within the institute
